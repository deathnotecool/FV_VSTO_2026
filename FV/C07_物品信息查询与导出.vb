...
Public Class C07_物品信息查询与导出
    ...
    Private Sub C07_物品信息查询与导出_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
            .Items.Add（"采购物品信息"）     '添加项目为合同基本信息
            .Items.Add（"采购进货信息"）   '添加项目为合同收费信息
            .Items.Add（"供应商信息")
            .Items.Add（"库存信息")
            .Items.Add（"物品消耗使用信息")
        End With                                '结束引用语句
    ...
    Private Sub 查询项目_SelectedIndexChanged(sender As Object, e As EventArgs) Handles 查询项目.SelectedIndexChanged
        ...
        With tb
            For inCounter = 0 To .Rows.Count - 1
                ...
                If 查询项目.Text = "出库使用日期" Or 查询项目.Text = "进货日期" Then
    ...
    Private Sub 开始查询_Click(sender As Object, e As EventArgs) Handles 开始查询.Click
        ...
        Con0 = " where "        '给变量赋值
        '如果查询项目的值等于相应的日期值
        If 查询项目.Text = "进货日期" Or 查询项目.Text = "出库使用日期" Then
    ...
    Private Sub 关闭窗体_Click(sender As Object, e As EventArgs) Handles 关闭窗体.Click
        ...
        Globals.Ribbons.Ribbon1.Button37.Enabled = True
        myArray = Nothing
        Me.Close()
    End Sub

    Private Sub C07_物品信息查询与导出_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        关闭窗体_Click(Nothing, Nothing)
    End Sub
