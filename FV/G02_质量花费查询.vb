...
Public Class G02_质量花费查询
    ...
    Private Sub G02_质量花费查询_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
            .Items.Add（"费用申请"）     '添加项目为合同基本信息
        End With                                '结束引用语句
    ...
    Private Sub 查询项目_SelectedIndexChanged(sender As Object, e As EventArgs) Handles 查询项目.SelectedIndexChanged
        ...
        With tb
            For inCounter = 0 To .Rows.Count - 1
                ...
                If 查询项目.Text = "申请日期" Or 查询项目.Text = "申请日期" Then
    ...
    Private Sub G02_质量花费查询_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        关闭窗体_Click(Nothing, Nothing)
    End Sub
