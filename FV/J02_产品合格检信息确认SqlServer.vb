...
Public Class J02_产品合格检信息确认SqlServer

    Dim objConnection1th As New SqlConnection("server=192.168.3.52,1433\SQLEXPRESS;database=合格检验系统确认;User ID=sa;Password=85773627;")  '张一帆服务器
...
路径 = @路径,备注说明 = @备注说明 WHERE 检查ID = @检查ID"
    ...
    Private Sub J02_产品合格检信息确认SqlServer_MouseMove(sender As Object, e As MouseEventArgs) Handles Me.MouseMove
        On Error Resume Next
        Dim b As Long
