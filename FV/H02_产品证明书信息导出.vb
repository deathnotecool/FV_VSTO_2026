...
Public Class H02_产品证明书信息导出
    ...
    Private Sub H02_产品证明书信息导出_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
            .Items.Add（"质保书"）     '添加项目为合同基本信息
        End With                                '结束引用语句
    ...
    Private Sub 数据导出_Click(sender As Object, e As EventArgs) Handles 数据导出.Click
        ...
        Dim i As Integer, j As Integer, objArray(,) As Object  '声明变量及数据类型  '声明变量及数据类型
        ...
        For i = 2 To tb.Rows.Count + 1 '数据记录数量+1 表示的是加上标题行为最后一行对应的Excel的行数
            ...
            ws.Hyperlinks.Add(xlapp.Cells(i, 10), xlapp.Cells(i, 10).value.ToString)
            xlapp.Cells(i, 10).value = "Click here"
        Next

        xlapp.Columns("J:J").ColumnWidth = 15 '指定列宽缩小
    ...
    Private Sub H02_产品证明书信息导出_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        关闭窗体_Click(Nothing, Nothing)
    End Sub
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        objDataAdapter1th.SelectCommand.CommandText = "select * from 质保书"
