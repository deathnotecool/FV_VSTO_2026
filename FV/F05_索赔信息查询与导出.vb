...
Public Class F05_索赔信息查询与导出
    ...
    Private Sub F05_索赔信息查询与导出_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
            .Items.Add（"索赔信息"）     '添加项目为合同基本信息
        End With                                '结束引用语句
    ...
    Private Sub 查询项目_SelectedIndexChanged(sender As Object, e As EventArgs) Handles 查询项目.SelectedIndexChanged
        ...
        With tb
            For inCounter = 0 To .Rows.Count - 1
                ...
                If 查询项目.Text = "统计始日" Or 查询项目.Text = "统计止日" Then
    ...
    Private Sub 开始查询_Click(sender As Object, e As EventArgs) Handles 开始查询.Click
        ...
        ElseIf 查询项目.Text = "毛坯抵扣" Or 查询项目.Text = "供应商确认" Or 查询项目.Text = "补货状态" Then
    ...
    Private Sub 数据导出_Click(sender As Object, e As EventArgs) Handles 数据导出.Click
        ...
        For i = 2 To tb.Rows.Count + 1 '数据记录数量+1 表示的是加上标题行为最后一行对应的Excel的行数
            ...
            ws.Hyperlinks.Add(xlapp.Cells(i, 14), xlapp.Cells(i, 14).value.ToString)
            xlapp.Cells(i, 14).value = "Click here"
        Next
        ...
        xlapp.Columns("N:N").ColumnWidth = 15 '指定列宽缩小
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        objDataAdapter1th.SelectCommand.CommandText = "select * from 索赔信息"
        objDataAdapter1th.Fill(objDataSet1th, "wxxx4")
        'objDataView1th = New DataView(objDataSet1th.Tables("wxxx3"))
        ...
        With ws.ListObjects("表4").Sort
            ...
            .Apply()
        End With
        xlapp.Columns("N:N").ColumnWidth = 15
        ws = Nothing        '释放变量
        wb = Nothing
        关闭窗体.PerformClick()
        关闭窗体_Click(Nothing, Nothing)
    ...
    Private Sub 关闭窗体_Click(sender As Object, e As EventArgs) Handles 关闭窗体.Click
        ...
        Globals.Ribbons.Ribbon1.btn索赔信息查询与导出.Enabled = True
        myArray = Nothing
        Me.Close()
    End Sub
