...
Public Class J03_合格检信息查询与导出

    Dim objConnection2th As New SqlConnection("server=192.168.3.52,1433\SQLEXPRESS;database=合格检验系统确认;User ID=sa;Password=85773627;")  '张一帆服务器
    ...
    Private Sub J03_合格检信息查询与导出_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
    ...
    Private Sub 关闭窗体_Click(sender As Object, e As EventArgs) Handles 关闭窗体.Click
        ...
        Globals.Ribbons.Ribbon1.btnSerachConformityInformathing.Enabled = True
        myArray = Nothing
        Me.Close()
    End Sub
