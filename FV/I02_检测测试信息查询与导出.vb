...
Public Class I02_检测测试信息查询与导出
    ...
    Private Sub I02_检测测试信息查询与导出_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        '为信息种类复合框设置项目
        With 信息种类       '引用复合框对象
            .Items.Add（"检测试验信息"）     '添加项目为合同基本信息
        End With                                '结束引用语句
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        objDataAdapter1th.SelectCommand.CommandText = "select * from 检测试验信息"
        objDataAdapter1th.Fill(objDataSet1th, "wxxx4")
        'objDataView1th = New DataView(objDataSet1th.Tables("wxxx3"))
    ...
    Private Sub 关闭窗体_Click(sender As Object, e As EventArgs) Handles 关闭窗体.Click
        ...
        Globals.Ribbons.Ribbon1.btnSearchInspect.Enabled = True
        myArray = Nothing
        Me.Close()
    End Sub
